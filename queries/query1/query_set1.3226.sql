...
CASE WHEN a.SPG_DESC IN ('RMBS AGENCY CMO', 'RMBS AGENCY CMO SUPPORT', 'RMBS AGENCY FLOATER', 'RMBS AGENCY INVERSE FLOATER') THEN 'CMO'
    ...
    WHEN (SPG_DESC IN ('GOVERNMENT', 'RATE FUTURES', 'SWAP', 'SWAPS') OR (SPG_DESC = 'OTHER' AND ACCOUNT IN ('07500JR18')) OR (SPG_DESC= 'CORPORATE AND CDS' AND ACCOUNT IN ('07200MT46','072001118','07200MTF1','07200MT38','07200KS58','07200MP40'))) AND CCC_STRATEGY IN ('AGENCY CMBS') THEN 'CMBS Swap & Govt'
    WHEN (SPG_DESC IN ('GOVERNMENT', 'RATE FUTURES', 'SWAP', 'SWAPS') OR (SPG_DESC = 'OTHER' AND ACCOUNT IN ('07500JR18')) OR (SPG_DESC= 'CORPORATE AND CDS' AND ACCOUNT IN ('07200MT46','072001118','07200MTF1','07200MT38','07200KS58','07200MP40'))) AND CCC_STRATEGY IN ('AGENCY DEBT TRADING') THEN 'Debenture Swap & Govt'
    WHEN (SPG_DESC IN ('GOVERNMENT', 'RATE FUTURES', 'SWAP', 'SWAPS') OR (SPG_DESC = 'OTHER' AND ACCOUNT IN ('07500JR18')) OR (SPG_DESC= 'CORPORATE AND CDS' AND ACCOUNT IN ('07200MT46','072001118','07200MTF1','07200MT38','07200KS58','07200MP40'))) AND CCC_STRATEGY IN ('AGENCY MORTGAGE TRADING1', 'AGENCY CMO TRADING', 'AGENCY MBS TRADING', 'AGENCY CMO', 'AGENCY PASS-THROUGH', 'US AGENCIES') THEN 'Resi Swap & Govt'
