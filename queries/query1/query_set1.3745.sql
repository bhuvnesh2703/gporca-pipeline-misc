SELECT
    a.COB_DATE, CCC_DIVISION, VERTICAL_SYSTEM,   FID1_INDUSTRY_NAME_LEVEL1,
    a.IS_UK_GROUP, book,
...
WHERE
    ...
    AND a.CURRENCY_OF_MEASURE = 'EUR' 
     AND COUNTRY_CD_OF_RISK in ('ESP')
and FID1_INDUSTRY_NAME_LEVEL1 in ('GOVERNMENT SPONSORED', 'SOVEREIGN')
and (book <> 'LRM' or VERTICAL_SYSTEM not like 'BT_%')
