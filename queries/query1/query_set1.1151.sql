SELECT
    ...
    A.CCC_STRATEGY,
    CASE WHEN A.CCC_PL_REPORTING_REGION IN ('ASIA PACIFIC', 'JAPAN') THEN 'ASIA'
    ELSE A.CCC_PL_REPORTING_REGION END AS CCC_PL_REPORTING_REGION,
    A.PNL_LEVEL_1,
    A.PNL_LEVEL_2,
    A.PRODUCT_TYPE,
...
GROUP BY
    ...
    A.BOOK, A.CCC_TRADE_STRATEGY, 
    CASE WHEN A.CCC_PL_REPORTING_REGION IN ('ASIA PACIFIC', 'JAPAN') THEN 'ASIA'
    ELSE A.CCC_PL_REPORTING_REGION END