SELECT
    a.COB_DATE, a.PRODUCT_TYPE_CODE, a.CURRENCY_OF_MEASURE,
    a.IS_UK_GROUP,
    a.CCC_PL_REPORTING_REGION,
    a.COUNTRY_CD_OF_RISK,
    a.CCC_BUSINESS_AREA,     a.TERM_NEW_GROUP,
    a.CURVE_NAME,
...
ELSE 'IR' end as CVA_FL, 
   ...
   SUM(coalesce(a.USD_IR_UNIFIED_PV01,0)) AS PV01,        
 SUM (a.USD_IR_KAPPA)/10 as USD_KAPPA
FROM cdwuser.u_DM_IR A
WHERE
    cob_date IN ('2018-02-28','2018-02-21') and
   a.CURRENCY_OF_MEASURE = 'EUR' 
   and a.FID1_INDUSTRY_NAME_LEVEL1 in ('SOVEREIGN','GOVERNMENT SPONSORED') 
   and country_cd_of_risk in  ('ITA', 'ESP', 'GRC', 'PRT')
