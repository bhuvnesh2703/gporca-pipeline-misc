...
ELSE 'IR' end as CVA_FL, 
   SUM(a.USD_IR_UNIFIED_PV01) AS PV01,                            /* pv01 for bonds and swaps */
   SUM (coalesce(a.USD_IR_KAPPA,0))/10 as USD_KAPPA,                                               /* 10% relative increase in Vol as we divided by 10 */
   SUM (a.USD_IR_PV01_BREAKEVEN) as USD_IR_PV01_BREAKEVEN        /* Inflation PV01 */


FROM cdwuser.U_IR_MSR_INTRPLT a
WHERE
  a.cob_date IN ('2018-02-28','2018-02-21') 
  AND a.CURRENCY_OF_MEASURE in ('RUB','RU1','RBX') 
