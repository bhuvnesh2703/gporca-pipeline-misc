...
from CDWUSER.U_DM_CC a
 where a.COB_DATE in ('2018-02-28') AND a.ISSUER_COUNTRY_CODE not in ('DNK','BMU','CYM','AUS','AUT','BEL','CAN','CHE','DEU','ESP','FIN','FRA',
 'GBR','GRC','IRL','ITA','JPN','LUX','NLD','NOR','NZL','PRT','SWE','USA',
 'JEY','GGY','SUP','XS','XCI','VGB','CYP','VEN','ISL','LIE','MLT')
...
AND a.ISSUER_COUNTRY_CODE not in ('DNK','BMU','CYM','AUS','AUT','BEL','CAN','CHE','DEU','ESP','FIN','FRA','GBR','GRC','IRL','ITA','JPN','LUX','NLD','NOR','NZL','PRT','SWE','USA','JEY','GGY','SUP','XS','XCI','VGB','CYP')
AND ISSUER_COUNTRY_CODE not in ('BRA','CHL','COL','HRV','CZE','EST','GRC','HUN','ISR','LVA','LTU','MEX',
 'PER','POL','QAT','RUS','SAU','SVK','SVN','ZAF','TUR','ARE','MYS','BHR','THA',
 'IDN','PHL','CHN','IND','HKG','SGP','TWN','KOR','VEN')
