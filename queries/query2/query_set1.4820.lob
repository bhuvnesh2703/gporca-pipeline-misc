...
from CDWUSER.U_DM_CC a where a.COB_DATE in ('2018-02-28') AND a.ISSUER_COUNTRY_CODE in ('BGR','HRV','BIH','CZE','EST','HUN','ISL','LVA','POL','ROM','SRB','SVK','SVN','LBR','LTU','ROU','KAZ','AZE','BLR','GEO','SLV','ARM','UKR','RUS','TUR') 
