...
from CDWUSER.U_DM_CC a where a.COB_DATE in ('2018-02-28') AND a.ISSUER_COUNTRY_CODE in ('EGY','MAR','GAB','GHA','AGO','MNE','MOZ','TZA','ETH','ETH','CIV','KEN','SEN','NGA','TUN','ZMB','NAM','RWA','ZAF')
