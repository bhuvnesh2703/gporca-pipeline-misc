...
CASE
 ...
 when spg_desc like 'WAREHOUSE%' then 'Warehouse' 
...
Else 'OTHER'  end as GROUPED_TRADING_LENDING,
    A.SPG_DESC,
--CASE WHEN MRD_RATING IN ('AAA','AA','A','BBB') THEN 'IG' ELSE 'NIG' END AS RATING2,
    RATING2,
    GROUPED_RATING,
...
WHERE
    a.COB_DATE IN
    ('2018-02-28', '2018-02-27', '2018-01-31', '2017-12-29', '2017-09-29')
    AND a.CCC_BUSINESS_AREA = 'SECURITIZED PRODUCTS GRP'
    AND a.CCC_PRODUCT_LINE IN ('CRE LENDING SEC/HFS', 'CREL BANK HFI', 'CRE LENDING', 'WAREHOUSE')
GROUP BY
    a.COB_DATE,
    A.CCC_STRATEGY,
    A.CCC_PL_REPORTING_REGION,
