SELECT
    ...
    a.VERTICAL_SYSTEM,
    a.PRODUCT_TYPE_CODE,
    a.PRODUCT_TYPE_NAME,COUNTRY_CD_OF_RISK,
...
WHERE
   ...
   ( ccc_business_area IN ('SECURITIZED PRODUCTS GRP') OR  CCC_DIVISION = 'NON CORE' )
AND a.PRODUCT_HIERARCHY_LEVEL7 NOT IN ('COVERED BOND-OTHER')
AND a.BOOK NOT IN ('COVERED BONDS') and
    COUNTRY_CD_OF_RISK IN ('ITA', 'ESP', 'GRC', 'PRT')
